...
import DeleteHook from "./AccountDeleteComponent";
        ...
        <div className="card" style={styleObject.containerStyle}>
            ...
            <div className="card-body">
                <div>
                    ...
                    <input type="button" className="btn btn-primary" value="Delete" onClick={DeleteHook(props.accountNumber)} /*deleteEmployee={props.accountNumber}*/ />
                </div>
            </div>
        </div>
    )
