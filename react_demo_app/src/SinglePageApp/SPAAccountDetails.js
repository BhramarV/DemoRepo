...
import GetHook from '../HooksImplementation/AccountApiGetWithHooks';

export default class SPAAccountDetails extends React.Component {
    constructor() {
        super();
        this.state = {
            userName: "Bhramar"
    ...
    return (
        <div>
            ...
            <nav>
                ...
                <Link style={{ margin: "10px" }} to="AddAccount">Add Account</Link>
